 ...
 * 根据url生成URL 对象
 */
declare const NewURL: (url: string) => {
    protocol: string;
    host: string;
    hostname: string;
    origin: string;
...
export { NewURL, array2Tree, beautifyRaw, bufferToRaw, completionHttpProtocol, _default as default, errorResult, formatHtml, formatXml, getUrlQuery, getUrlQueryArray, isEmail, isHtml, isJson, isJson5, isJsonp, isXml, jsonp2Obj, ms2second, successResult };
